...
$SelectServices = SELECT("SELECT * FROM blogs where blog_id='$Id'");
...
<head>
  ...
  <title><?php echo $FetchServices['blog_title']; ?> | <?php echo CONFIG("APP_NAME"); ?></title>
    ...
    <div class="container-fluid">
      <div class="row justify-content-center">
        <div class="col-md-12 col-lg-12">
          <img src="<?php echo DOMAIN . "/storage/img/blogs/" . $FetchServices['blog_feature_image']; ?>" class="img-fluid">
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container-fluid">
      <div class="row pl-3 pr-3">
        <div class="col-md-11 col-11 text-justify d-block mx-auto pt-4 pb-5">
          ...
          <?php echo SECURE("" . $FetchServices['blog_description'] . "", "d"); ?>
